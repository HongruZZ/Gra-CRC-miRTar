...
if __name__ == '__main__':
    ...
    argp.add_argument('--inputs', help='FASTA files', nargs='+', default='./New_data/mirna_mammal/*fasta')
    ...
    argp.add_argument('--Min_seq', help='cut sequence min length', type=int, default=20)
    argp.add_argument('--Max_seq', help='cut sequence max length', type=int, default=30)
    argp.add_argument('--vec_dim', help='vector dimension', type=int, default=100)
    argp.add_argument('--context', help='half size of context window (the total size is 2*c+1)', type=int, default=10)
    argp.add_argument('--epochs', help='number of epochs', type=int, default=10)
    argp.add_argument('--gensim_iters', help="gensim's internal iterations", type=int, default=1)
    argp.add_argument('--out_dir', help="output directory", default='./results')
    ...
    inputs = [s for s in glob.glob(args.inputs)]
    print(inputs)
    ...
    out_file = '{}/{}-{}-{}'.format(out_dir,'5-mer-lnc-RNA2vec',arrow.utcnow().format('YYYYMMDD-HHmm'),out_file_suffix,)
